# Use Case 1 Phone Conference: 30/06/2010, 09:00-09:30
...
- Mathieu Kazmierski (IOW-Sandre)

## Agenda

- status report implementations
- status report participants

## Results

- SOS-Server implementation 52°north:
  - coordination with CSIRO work in progress
  - meeting with Pete Taylor during Silver Springs TC
  - planned reintegration of CSIRO code extensions end of July/start August
...
- disy
  ...
  - CSW ot until later in the year since there is ongoing work at disy
  - Mailing list for Use Case 1 has been requested
- IOW-Sandre
  - national database has been converted to O&M2.0
  - next step: deployment of 52°north SOS server
  - interested in DAO creation
  - waiting for CSIRO code to be available
- regular phone conference
  - biweekly schedule is ok
  - best time in the week is Thursday at 14:00 (MEST)
