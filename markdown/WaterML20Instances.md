...
- Document validates using schemas available from SVN (see in trunk\\[GeneratedSchema_June_2010](GeneratedSchema_June_2010), never mind the import path I use in the instance document, you must get them from SVN)
