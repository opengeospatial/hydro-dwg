...
*There a need (**rgs-21**) to have a [WaterML2](WaterML2) vocabulary that defines a set of standard range tables? Users would no doubt need to be able to extend the vocabulary.*
