...
- Click here for the [Doodle poll](http://doodle.com/c88yn995t74vtwfv)

**Results**

- Document
  - Tues 05 Aug 2013: complete draft
    - Eric and Bruce: requirements and conformance classes
    - Sylvain: coordinate XML instances and generate diagramatic description (time permitting)
    - Boyan: cut and paste UML + documentation, first sections
  - Wed 06 Aug - Fri 08 Aug: draft review by GW2IE team
  - Mon 11 Aug: circulate to HDWG
  - Wed 13 Aug: present draft to HDWG
  - 14 Aug - Sept: feedback from HDWG
  - Sept - Dec: revise document, pending use-case implementation results
  - Jan - Mar - June:
...
- Use-case implementation
  ...
  - carry out implementation Sept - Dec 2014
...
- **Screen sharing (Webex):**
  ...
  - **Meeting** **URL**: click below, then enter name, email, password, and click "**Join Now"**:
    - <https://pwgsc-nh.webex.com/pwgsc-nh/j.php?MTID=mb04ec25da9165a9716e166df0f577498>
- **Teleconference:**
