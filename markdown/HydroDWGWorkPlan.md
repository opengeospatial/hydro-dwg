...
- Collaboration with other DWGs, in particular ESS (on modelling), [MetOcean](MetOcean) (on handling gridded data), SWE (on real time data management)

#### Sub-groups:

- Design group: primarily responsible for driving [WaterML](WaterML) 2.0
...
- Proposed [WaterML](WaterML) 2.0 schema announced
- IE1 officially launched, IEs 2-3 announced and IE teams formed
- Work plan and first steps discussed

**March 2010**

- [WaterML](WaterML) 2.0 documentation posted for wider discussion
