...
- Technical
  ...
  - \_Pump & Well Test proposal\_:
    ...
    - specification document to be updated: requirements and conformance classes (**Eric, Sylvain**)
    - New entity to be added to model (which package?): [vote here for name of Test](http://doodle.com/yv6m9s2xfa3cnybt)
  - \_Geology log\_:
...
- Use-Case Implementation
  - Use cases 1,3,4,5: in progress; different levels of progress among participants
    - End-April or End-May workable deadlines for most participants (but perhaps not all).. to be reviewed
  - Use case 2: deferred until Management Area outcome
