...
Meeting slides - [Wiki page attachment](https://raw.githubusercontent.com/opengeospatial/hydro-dwg-wiki-docs/main/20130830-OzStartupMtg/WaterML2.Part2_-_OzStartupMtg.pdf) [Scenario Overview](https://raw.githubusercontent.com/opengeospatial/hydro-dwg-wiki-docs/main/20130830-OzStartupMtg/RatingsGaugingsIE.docx) [IE Overview](https://raw.githubusercontent.com/opengeospatial/hydro-dwg-wiki-docs/main/20130830-OzStartupMtg/RatingsGaugingsIE.docx)
...
As you can appreciate we don’t have all the answers yet, but are working towards building clarity and definition in the activity. A significant part of this process is to first understand what the questions are that need to be answered, this first meeting will give opportunity for these questions to come out.

Attached are two Interoperability experiment overview documents, these document articulate the project objectives at the high level and a useful for project orientation.

We have set up a poll to assist in determining the most convenient meeting time. Please open the poll, enter your name and let us know your preferences.

The poll can be found at <http://doodle.com/f3nw9uhhbbn754dc>.

Thanks and we look forward catching up.

Paul and Pete.

\_\_Attachments\_\_

1.  Ratings, gaugings and cross-sections Interoperability Experiment brief
2.  RGS Interoperability Experiment – Australian scenario overview
