# **[GW2IE](GW2IE) Meeting 9** **-- Wed 18 Dec 2013 -- Conceptual Model**
...
- Work Items
  ...
  - Face-to-face meeting possible venues (tbd Jan 2014):
...
- GW Management properties
  - included for INSPIRE compatibility
  - moved to specific classes (AquiferSystem, Aquifer)
- GW properties (Unit, Void, Body)
  - confirmed Void entity independent of Unit and Porosity
  - modified Yield (to be discussed more)

## **Connection Instructions**

- **Meeting Date**: Wed 18 Dec 2013
...
- **Screen sharing (Webex):**
  ...
  - **Meeting** **URL**: click below, then enter name, email, password, and click "**Join Now"**:
    - <https://pwgsc-nh.webex.com/pwgsc-nh/j.php?ED=263738927&UID=0&PW=NNDQ4OTEyNzA3&RT=NCMxMQ%3D%3D>
- **Teleconference:**
