...
- Technical
  - Data Record:
    - report updated? (Eric)
  - Namespaces & URIs:
    - update report: change stubs of urls/uris top variable (Eric)
    - Servers for domain
  - Mandatory properties:
    - update report (Francois)
  - Pump proposal (Eric)
  - Well test proposal (Sylvain, Eric)
  - BoreCollar:
...
- Click here for the [Doodle poll](http://doodle.com/x9y95u2y2gtqibhm)
