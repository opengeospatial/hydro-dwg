# **[GW2IE](GW2IE) Meeting 22** **-- Wed 23 July 2014 -- Report**

## **Agenda**

- [AGU session](https://agu.confex.com/agu/fm14/webprogrampreliminary/Session2591.html) on geoscience info models
  - volunteers? Abstracts due 06 Aug 2014.
- SVN
  - update: issues?
- Report
  - update: document management (Boyan)
...
- **Screen sharing (Webex):**
  ...
  - **Meeting** **URL**: click below, then enter name, email, password, and click "**Join Now"**:
    - <https://pwgsc-nh.webex.com/pwgsc-nh/j.php?MTID=m30e97128c013cec5dcb22edd1ef7219d>
- **Teleconference:**
