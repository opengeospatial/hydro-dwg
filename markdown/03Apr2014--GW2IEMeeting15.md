...
- OGC status update
- Work Items
  - Vienna meeting update
    - Agenda items
  - Conceptual model comparision: GWML2 and INSPIRE
    - plan to make a comparison to ensure conceptual compatibility
  - Conceptual model development
    - outstanding items identified by Bruce S.
    - time stamp for fluid body (to indicate valid time frame)
    - assess fluid body constituents

## **Participants**

- Click here for the [Doodle poll](http://doodle.com/a654ch62f75t5hgu)

## **Results**

- Management Area:
  - added relation to fluid body, recognizing that fluid bodies in a management area might not be identical to those in its aquifers (e.g. might be a portion)
    - added yield to management area, recognizing area yield might differ from unit yield (for same reasons as above)
  - added type to capture different kinds of areas
- Metadata
  - confirmed metadata atrribute needs to be added in various places, for consistency
    - to be ammened by Bruce S. and posted for discussion by next meeting
- Names
  - confirmed cardinality and naming change, for consistency
    - to be ammended by Bruce S. and posted for discussion by next meeting
- Fluid Body Constituents
  - recognized missing inter-constituent relations, e.g. materials/chemicals, biologic/material, biologic/chemical
    - Boyan B. and Bruce S. to ammend and post by next meeting
...
- **Screen sharing (Webex):**
  ...
  - **Meeting** **URL**: click below, then enter name, email, password, and click "**Join Now"**:
    - <https://pwgsc-nh.webex.com/pwgsc-nh/j.php?MTID=mcbe0cdf7d940f40ffb421fe0e7384f9b>
- **Teleconference:**
