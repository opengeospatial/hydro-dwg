...
- old business
- OGC TC meeting report
- GWML2 Specification document
- next steps

## **Results**

- old business
  - GW2IE Eng Report: verify OGC approval status (**done -- Boyan**)
    - Approved in Nov 2015, in queue for OGC web release
  - Replacement GGS? (**Boyan**)
- OGC TC:
  - HDWG: GWML2 SWG charter approved
  - OGC TC: GWML2 SWG charter approved for electronic vote
    - electronic vote duration is 45 days (mid-Dec to end-Jan)
    - to start next week (week of Dec 13th)
...
- GWML2 specification: complete by mid-Feb
  ...
  - Others: (implications: **Eric**)
    ...
    - GeoSciML 4?
- Next Steps
  - Doodle Poll re: 2016 meetings (**Boyan**)
    - Please complete poll... [here](http://doodle.com/poll/b2bycxu3yccb4ya3)

## **Participants**

- Click here for the [Doodle Poll](http://doodle.com/poll/59z4qw96kawg4qzn)
